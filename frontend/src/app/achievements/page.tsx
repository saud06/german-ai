        ...
        {stats && (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 border-2 border-indigo-200">
              ...
              <div className="text-4xl font-bold text-indigo-600 mb-2">{stats.level}</div>
              ...
              <p className="text-sm text-gray-500">{stats.total_xp} XP / {stats.xp_to_next_level} to next level</p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 border-2 border-orange-200">
              ...
              <div className="text-4xl font-bold text-orange-600 mb-2">{stats.current_streak}</div>
              <p className="text-sm text-gray-500">Longest: {stats.longest_streak} days</p>
            </div>

            {/* Scenarios Card */}
            <div className="bg-white rounded-xl shadow-lg p-6 border-2 border-cyan-200">
              <div className="flex items-center justify-between mb-2">
                <span className="text-gray-600 font-medium">Scenarios</span>
                <span className="text-3xl">🎭</span>
              </div>
              <div className="text-4xl font-bold text-cyan-600 mb-2">{stats.scenarios_completed}</div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 border-2 border-emerald-200">
              ...
              <div className="text-4xl font-bold text-emerald-600 mb-2">{stats.words_learned}</div>
                  ...
                  <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-lg p-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="font-bold">{stats.scenarios_completed}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">Words Learned:</span>
                        <span className="font-bold">{stats.words_learned}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">Quizzes Completed:</span>
                        <span className="font-bold">{stats.quizzes_completed}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">Quiz Accuracy:</span>
                        <span className="font-bold">{(stats.quiz_accuracy * 100).toFixed(1)}%</span>
                      </div>
                    </div>
                  </div>

                  <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-lg p-6">
                    <h3 className="font-bold text-lg mb-4">Streak Information</h3>
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        <span className="text-gray-600">Current Streak:</span>
                        <span className="font-bold text-orange-600">{stats.current_streak} days 🔥</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">Longest Streak:</span>
                        <span className="font-bold">{stats.longest_streak} days</span>
                      </div>
              ...
              <div>
                {userRank && (
                  <div className="bg-gradient-to-r from-yellow-100 to-orange-100 rounded-lg p-4 mb-6 border-2 border-yellow-300">
                    <div className="flex items-center justify-between">
                      <span className="font-bold text-lg">Your Rank: #{userRank}</span>
                  ...
                  {leaderboard.map((entry, index) => (
                    ...
                    >
                      ...
                      <div className="text-right">
                        <div className="font-bold text-indigo-600">{entry.total_xp} XP</div>
                        <div className="text-sm text-gray-500">{entry.current_streak} day streak 🔥</div>
                      </div>
                    </div>
                  ))}
                </div>
