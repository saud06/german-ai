    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">🗺️ Your German Journey</h1>
          <p className="text-lg text-gray-600">Learn German by living a virtual life in Germany</p>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border-2 border-indigo-200">
            <div className="flex items-start justify-between mb-6">
              <div>
                ...
                <h2 className="text-3xl font-bold text-gray-900 mb-2">{currentPath.path.title}</h2>
                <p className="text-gray-600">{currentPath.path.description}</p>
              </div>
            ...
            <div className="bg-indigo-50 rounded-lg p-4 mb-6">
              <p className="text-gray-700 italic">{currentPath.path.story}</p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className="font-bold text-indigo-600">{progress?.total_xp || 0}</span>
              </div>
              <div className="flex justify-between items-center">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-bold">{progress?.conversations_held || 0}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600 flex items-center gap-1">
                ...
                <span className="font-bold">{progress?.words_learned || 0}</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="space-y-3">
              <div>
                <div className="text-sm text-gray-600 mb-1">Housing</div>
              ...
              <div>
                <div className="text-sm text-gray-600 mb-1">Cities Visited</div>
                <div className="font-semibold text-gray-900">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="space-y-3">
              {recommendations?.slice(0, 3).map((rec, idx) => (
                <div key={idx} className="border-l-4 border-indigo-500 pl-3 py-2">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <span className="text-xs text-gray-500">⏱️ {rec.estimated_minutes} min</span>
                    <span className="text-xs text-indigo-600 font-semibold">+{rec.xp_reward} XP</span>
                  </div>
                </div>
              ))}
              ...
              {challenges.map((challenge) => (
                <div key={challenge.id} className="border border-gray-200 rounded-lg p-4">
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <div className="text-sm font-bold text-indigo-600">+{challenge.xp_reward} XP</div>
                  </div>
            ...
            {paths?.map((pathData) => {
              ...
              return (
                ...
                >
                  ...
                  <h4 className="font-bold text-gray-900 mb-1">Chapter {path.chapter}: {path.title}</h4>
